...
use Aiden\Models\FairfieldcityTask;
                ...
                if($da->save()){
                    switch ($da->getCouncilId()){
                        ...
                        case 11:
                            ...
                            break;
                        case 12:
                            $georges = new GeorgestiverTask();
                            $georges->init(['documents'], $da);
                            $georges = null;
                        case 13:
                            $hornsbyshire = new HornsbyshireTask();
                            $hornsbyshire->init(['documents'], $da);
                            $hornsbyshire = null;
                            break;
                        case 14:
                        ...
                        case 20:
                            ...
                            break;
                        case 21:
                            $parramatta = new ParramattaTask();
                            $parramatta->init(['data', 'documents'], $da);
                            $parramatta = null;
                            break;
                        case 22:
