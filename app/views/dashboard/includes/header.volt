        ...
        <ul class="nav-right">
            <li class="user-profile dropdown">
                <a href="" class="dropdown-toggle" data-toggle="dropdown">
                    <img class="profile-img img-fluid" src="{{ url('aiden-assets/') }}{{ loggedInUser.image_url}}" alt="">
                    <div class="user-info">
                        <span class="name pdd-right-5">{{ loggedInUser.getEmail() }}</span>
